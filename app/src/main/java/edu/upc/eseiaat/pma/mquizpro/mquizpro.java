package edu.upc.eseiaat.pma.mquizpro;
...
public class mquizpro extends AppCompatActivity {
    ...
    //Per guardar les dades quan es tanqui el programa.
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mquizpro);
